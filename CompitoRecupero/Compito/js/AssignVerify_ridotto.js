...
function assignAll(){
	...
	*********************/
	...
	/********************
		Densità r_cilindro
	*********************/
	randomAssignmenMaterialDensity("material_es8_1","material_es8_2","d_es8");	
	randomAssignmentIntRangeK("m_es8",2,0,1,1,1);	
	randomAssignmentIntRangeK("r_es8",2,0,0,1,1);
}
...
function verifyAll(){
	...
	***********************/
	...
	/**********************
		Formule inverse
	***********************/
	result = verifyInvFormula4("NumSx_1","DenSx_1","NumDx_1","DenDx_1","result_0_Num","result_0_Den","result_1_Num","result_1_Den","result_2_Num","result_2_Den","result_3_Num","result_3_Den","result_es7","pointsAvail_es7","points_es7")	
	pointsTotRealized += result[0];
	pointsTotAvail += result[1];
